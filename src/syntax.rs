...
static C: Language = Language {
    ...
    types: &[
        ...
        "uint32_t", "uint64_t", "uintptr_t", "intptr_t", "FILE",
    ],
    line_comment: "//",
    block_comment: Some(("/*", "*/")),
    strings: &['"', '\''],
...
static CPP: Language = Language {
    ...
    keywords: &[
        ...
        "override", "private", "protected", "public", "return", "sizeof", "static", "struct",
...
static PYTHON: Language = Language {
    ...
    keywords: &[
        ...
        "is", "lambda", "match", "nonlocal", "not", "or", "pass", "raise", "return", "self",
...
static JS: Language = Language {
    ...
    types: &["Array", "Object", "String", "Number", "Boolean", "Promise", "Map", "Set", "Math", "JSON"],
    line_comment: "//",
    block_comment: Some(("/*", "*/")),
    strings: &['"', '\'', '`'],
    highlight_caps: false,
...
static TS: Language = Language {
    ...
    keywords: &[
        ...
        "instanceof", "interface", "keyof", "let", "namespace", "never", "new", "null", "of",
        "private", "protected", "public", "readonly", "return", "set", "static", "super",
        "switch", "this", "throw", "true", "try", "type", "typeof", "undefined", "unknown",
        "var", "void", "while", "yield",
    ],
    types: &["string", "number", "boolean", "object", "Array", "Promise", "Record", "Partial"],
    line_comment: "//",
    block_comment: Some(("/*", "*/")),
    strings: &['"', '\'', '`'],
    highlight_caps: true,
...
static JAVA: Language = Language {
    ...
    keywords: &[
        ...
        "protected", "public", "record", "return", "static", "strictfp", "super", "switch",
        "synchronized", "this", "throw", "throws", "transient", "true", "try", "var", "volatile",
        "while",
    ],
    types: &["int", "long", "double", "float", "boolean", "char", "byte", "short", "void", "String"],
    line_comment: "//",
    block_comment: Some(("/*", "*/")),
    strings: &['"', '\''],
    highlight_caps: true,
...
static CSS: Language = Language {
    name: "css",
    exts: &["css", "scss", "less"],
    keywords: &["important", "media", "keyframes", "import", "font-face", "root"],
    types: &[],
    line_comment: "",
    block_comment: Some(("/*", "*/")),
    strings: &['"', '\''],
...
static SHELL: Language = Language {
    ...
    keywords: &[
        ...
        "function", "return", "exit", "local", "export", "source", "echo", "read", "set",
...
static LANGS: &[&Language] = &[
    &RUST, &C, &CPP, &PYTHON, &JS, &TS, &GO, &JAVA, &JSON_LANG, &TOML, &YAML, &HTML, &CSS,
    &SHELL,
];
...
pub fn highlight_line(line: &str, lang: &Language, state: LineState) -> (Vec<Tok>, LineState) {
    ...
    while i < n {
        ...
        if c.is_alphabetic() || c == '_' {
            ...
            {
                Tok::Type
            } else if j < n && (chars[j] == '(' || (chars[j] == '!' && j + 1 < n && chars[j + 1] == '(')) {
                Tok::Func
            } else {
                Tok::Normal
            };
...
mod tests {
    ...
    fn comment_start_inside_string_ignored() {
        let (toks, st) = highlight_line(r#"s = "no // comment""#, lang("rust"), LineState::default());
        assert!(!st.in_block);
